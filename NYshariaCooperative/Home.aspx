<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="NYshariaCooperative.Anggota" %>
...
<ul class="auto-style1">
  ...
  <li style="font-family: ABeeZee"><a class="active"  href="Home.aspx"><strong>Home</strong></a><strong></li>
  <img src ="obj/logo_cooperative.png" style="margin: 10px 10px 5px 20px; width: 54px; height: 52px;"/><strong> NY Koperasi Syariah
</strong>
  
</ul>

        <asp:Panel ID="Panel1" runat="server" BackColor="#8AF3AC" BorderColor="#2A8FBD" style="padding: 0px; margin-left: 0px; margin-right: 0px; " Height="461px">
        <img src ="obj/Halamanutama.png" style="padding: 0px; margin-left: 0px; margin-right: 0px; margin-bottom: 0px;" class="auto-style3"/></asp:Panel>
    </form>
